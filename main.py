# Importando thinker para criar a interface gráfica
from tkinter import *
...
#Irei dividir a janela em duas partes usando Frames, uma para o visor e outra para o corpo da calculadora
